...
<template>
    <ul class="nav_links">
        ...
        <li>
            <button class="nav_link" @click="handleLink('/feed/all')" :style="handleSelectedStyle('/feed')">
                Feed
            </button>
        </li>
        <li>
            <button class="nav_link" @click="handleLink('/digest/most-viewed')" :style="handleSelectedStyle('/digest')">
                Digest
            </button>
        </li>
        <li>
